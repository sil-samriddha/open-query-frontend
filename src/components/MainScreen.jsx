        ...
        <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
            <div data-aos="fade-up" className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
                 <div className='flex flex-row items-center py-[6px] px-1 rounded-[10px] mb-2'>
                  <p>
                    <span style={boldTop}>Free</span> &nbsp;
                    <span style={nomTop}>&</span> &nbsp; 
                    <span style={boldTop}>Open Source</span> &nbsp; 
                    <span style={nomTop}>tool to</span> 
                  </p>
                 </div>
                 <div className='flex flex-row justify-between items-center w-full'>
                  <span data-aos="fade-right" className='flex-1 font-semibold ss:text-[72px] text-[52px] ss:leading-[100px] leading-[75px]'>
                    ...
                    <span className="text-[42px]" style={props.mode==="black"?{color: "rgba(255,255,255,1)"}:{color: "rgba(176, 74, 144, 0.5)"}}>through</span>
                  </span>
                 ...
                 <h1 data-aos="fade-right" className='font-semibold text-[45px] ss:leading-[100px] leading-[75px] w-full'>
